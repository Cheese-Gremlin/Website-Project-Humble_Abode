...
my own art:
![](read_me-images/desktop_background.png) <- my desktop background that I drew myself, with shelves to align all my files
![](read_me-images/dsdn142-project_2-music_visualizer.png) <- a drawing I did for a uni project where certain elements move with the music. I really like this idea as it makes it feel lively. 
...
🏠Home page:
    ...
    ![alt text](read_me-images/home_page_sketch.png)
    Elements:
...
output:
    ![alt text](read_me-images/Home_page-pt1.png)
    ![alt text](<read_me-images/AI code pt1.1.png>)
...
![alt text](read_me-images/copright-update.png)
...
![alt text](read_me-images/home_page-pt3.png)
    issue fixed
...
![alt text](<read_me-images/AI code pt2.png>)
    What to tweak:
